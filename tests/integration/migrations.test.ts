...
describe("database migrations", () => {
  ...
  `); await expect(client.exec(`insert into checkins(tenant_id,event_id,participant_id,status,method) values ('00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000004','checked_in','qr')`)).rejects.toThrow(); }, 20_000);
});

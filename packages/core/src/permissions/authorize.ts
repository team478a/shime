...
const grants: Record<StaffRole, ReadonlySet<Permission>> = {
  ...
  manager: new Set(["checkin:write", "participant:read", "operations:read", "application:import", "application:duplicates", "notification:write", "event:write", "seating:write", "seating:publish", "preference:read", "result:confirm", "backup:export", "backup:sensitive", "concierge:manage", "concierge:publish"]),
  system_admin: new Set(["checkin:write", "participant:read", "operations:read", "application:import", "application:duplicates", "notification:write", "event:write", "event:delete", "seating:write", "seating:publish", "preference:read", "result:confirm", "result:revoke", "backup:export", "backup:sensitive", "concierge:manage", "concierge:publish", "concierge:private-read"]),
};
